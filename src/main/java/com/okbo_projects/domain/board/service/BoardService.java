...
//    // 특정 팀 전체 조회
//    @Transactional(readOnly = true)
//    public Page<BaordReadTeamPageResponse> getBoardTeamAllPage(String teamName, Pageable pageable) {
//        Page<Board> boardPage = boardRepository.findByTeam(teamName, pageable);
//        return boardPage.map(i -> BaordReadTeamPageResponse.from(BoardDto.from(i)));
//    }
//
//    // 팔로워가 작성한 게시물 전체 조회
//    @Transactional(readOnly = true)
//    public Page<BoardReadFollowPageResponse> getBoardFollowAllPage(Pageable pageable) {
//
//        Page<Board> boardPage = boardRepository.findBoardFollowAllPage(pageable);
...
//        matchedAuthor(userId, board.getUser().getId());
...
//
//    // 작성자 일치 확인
//    private void matchedAuthor(Long userId, Long boardUserId) {
